...
{
	if (nrhs < 2)
		mexErrMsgTxt("Too few arguments in dZdE_thg.\n");

	if (nrhs > 2)
		mexErrMsgTxt("Too many arguments in dZdE_thg.\n");

	if (nrhs < 0)
		mexErrMsgTxt("Too few outputs in dZdE_thg.\n");

	if (nlhs > 1)
		mexErrMsgTxt("Too many outputs in dZdE_thg.\n");
